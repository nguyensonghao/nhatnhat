            ...
            <div class="header-right col-4 col-md-9">
                <nav class="header-menu">
                    <ul id="main-menu" class="main-menu">
                        <li class="{!! (Route::is('home') ? 'class="current-menu-item"' : '') !!} menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-93">
                            <a href="/" aria-current="page">Trang Chủ</a>
                        </li>
                        <li class="{!! (Route::is('webbanggia') ? 'class="current-menu-item"' : '') !!} menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-93">
                            <a href="/" aria-current="page">Bảng Giá</a>
                        </li>
                        <li class="{!! (Route::is('webchinhsach') ? 'class="current-menu-item"' : '') !!} menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-93">
                            <a href="/" aria-current="page">Chính Sách</a>
                        </li>
                        <li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-93">
                            <a href="/" aria-current="page">Theo Dõi Mã Vận Đơn</a>
                        </li>
                    </ul>
                </nav>
